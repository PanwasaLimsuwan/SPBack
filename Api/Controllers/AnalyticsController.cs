        ...
        switch (body.key)
        {
            case "ot-hotspots":
                result = new
                {
                    ...
                    data = await _repo.OT_Hotspots(body)  // ฟังก์ชันที่ต้องการ
                };
                break;
            ...
            case "headcount-vs-plan":
                result = new
                {
                    ...
                    data = await _repo.HeadcountVsPlanVariance(body)  // ฟังก์ชันที่ต้องการ
                };
                break;
            ...
            case "absence-streaks":
                result = new
                {
                    ...
                    data = await _repo.AbsenceStreaks(body)  // ฟังก์ชันที่ต้องการ
                };
                break;
            ...
            case "eicc-risk":
                result = new
                {
                    ...
                    data = await _repo.EICC_Risk(body)  // ฟังก์ชันที่ต้องการ
                };
                break;
            ...
            default:
                result = new
                {
                    ...
                    data = await _repo.SkillGapByProcess(body)  // ฟังก์ชันที่ต้องการ
                };
                break;
        }
