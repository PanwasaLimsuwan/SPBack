...
const fetchSkillData = async () => {
  try {
    const response = await fetch(`https://databasemanpowerdb.database.windows.net/api/Skill?division=${props.filters.division !== 'ALL' ? props.filters.division : ''}&department=${props.filters.department !== 'ALL' ? props.filters.department : ''}&section=${props.filters.section !== 'ALL' ? props.filters.section : ''}&biz=${props.filters.biz !== 'ALL' ? props.filters.biz : ''}&process=${props.filters.process !== 'ALL' ? props.filters.process : ''}`);
